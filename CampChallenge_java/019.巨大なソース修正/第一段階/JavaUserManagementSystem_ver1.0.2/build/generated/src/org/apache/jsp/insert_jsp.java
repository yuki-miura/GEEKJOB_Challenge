...
public final class insert_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    UserDataBeans udb = (UserDataBeans) hs.getAttribute("udb");
      ...
      out.write("\n");
      out.write("\n");
      out.write("<meta charset=\"UTF-8\"><!DOCTYPE html>\n");
      out.write("<html>\n");
      out.write("    <head>\n");
...
if (udb != null) {
      ...
      out.write('"');
      out.write(' ');
if (udb != null && udb.getYear() == null && udb.getYear().equals(y)) {
      out.print(Integer.parseInt(udb.getYear()));
      out.write(" selected ");
 }
      out.write(' ');
      out.write('>');
      ...
      out.write('"');
      out.write(' ');
if (udb != null && udb.getMonth() == null && udb.getMonth().equals(m)) {
      out.print(Integer.parseInt(udb.getMonth()));
      out.write(" selected ");
 }
      out.write(' ');
      out.write('>');
      ...
      out.write('"');
      out.write(' ');
if (udb != null && udb.getDay() == null && udb.getDay().equals(d)) {
      out.print(Integer.parseInt(udb.getDay()));
      out.write(" selected ");
 }
      out.write(' ');
      out.write('>');
...
if (udb != null && udb.getType().equals("3")) {
      ...
      out.write("\n");
      out.write("            電話番号:\n");
      out.write("            <input type=\"tel\" name=\"tell\" maxlength=\"13\" value=\"");
if (udb != null) {
      out.print(udb.getTell());
}
      out.write("\" placeholder=\"-を付けてください\">\n");
      out.write("            <br><br>\n");
      out.write("\n");
      out.write("            自己紹介文\n");
      out.write("            <br>\n");
